  ...
  return (
    <div className="flex min-h-[80vh] justify-center bg-blue-400 py-12 text-white-400" id="sobre-mim">
      <div className="grid h-full w-[60%] grid-cols-4 items-center justify-items-center gap-24 tab:grid-cols-2 tab:grid-rows-[100px_repeat(3,_1fr)] tab:gap-0 tab:w-[80%]">
        ...
        <h2 className="col-start-1 col-end-3 text-3xl tab:col-start-1 tab:row-start-3">
          ...
          <span className="text-red-400">”</span> <span className="text-lg text-red-400"> - Max Weber</span>
        </h2>
        <Lightbulb
          size={48}
        ...
        />
        <p className="col-start-2 col-end-5 row-start-3 text-2xl tab:col-start-1 tab:row-start-5">
